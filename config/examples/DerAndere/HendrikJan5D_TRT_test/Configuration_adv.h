...
#define USE_CONTROLLER_FAN
 ...
 #define CONTROLLER_FAN2_PIN FAN3_PIN      // Set a custom pin for the controller fan 2  
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE    250 // (0-255) Active speed, used when any motor is enabled
...
#define CALIBRATION_GCODE
  ...
  // Define the pin to read during calibration
    ...
    #define CALIBRATION_PIN PF4            // Define here to override the default pin. PENTA_AXIS_HH C axis J_STOP_PIN
...
#define SAFE_BED_LEVELING_START_Z 200
