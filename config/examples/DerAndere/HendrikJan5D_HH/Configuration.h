...
#define CUSTOM_MACHINE_NAME "5D Printer"
...
#endif
#ifdef J_DRIVER_TYPE
  #define AXIS5_NAME 'B' // :['B', 'C', 'U', 'V', 'W'] Head
  #define AXIS5_ROTATES
#endif
#ifdef K_DRIVER_TYPE
  #define AXIS6_NAME 'C' // :['C', 'U', 'V', 'W'] Tilt Table
  #define AXIS6_ROTATES
#endif
#ifdef U_DRIVER_TYPE
  #define AXIS7_NAME 'U' // :['U', 'V', 'W'] Rotate Table
...
#define SAFE_TOOLCHANGE_START_Z           190
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.00, 160.00, 1600.00, 444.444, 444.444, 907.868 }
